        ...
        <div className='flex flex-col lg:flex-row justify-between items-start gap-10'>
            ...
            <motion.div 
               ...
               <div className='grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 items-start md:gap-12 gap-8'>
                    <div className='bg-[rgba(255, 255, 255, 0.04)] rounded-[35px] h-96 shadow-3xl 9-8 flex items-center justify-center hover:-translate-y-4 transition-all duration-300 cursor-pointer'>
                        <div>
                    ...
                    <div className='bg-[rgba(255, 255, 255, 0.04)] rounded-[35px] h-96 shadow-3xl 9-8 flex items-center justify-center hover:-translate-y-4 transition-all duration-300 cursor-pointer md:mt-16'>
                        <div>
