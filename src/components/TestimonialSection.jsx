...
const TestimonialSection = () => {
  ...
  return (
    <div className='max-w-6xl mx-auto w-[90%] py-14'>
      <h2 className='text-center font-semibold text-xl md:text-4xl mb-5 md:mb-10'>
      ...
      >
        {testimonialDetails.map(({ role, text, img }, index) => (
          <SwiperSlide key={index} className='grid sm:grid-cols-2 lg:grid-cols-3 md:w-11/12 m-auto'>
            <TestimonialBox img={img} name={role} text={t(text)} /> 
          </SwiperSlide>
        ))}
      </Swiper>
    </div>
